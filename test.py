import pandas as pd
df_sap = pd.read_excel('/home/j0ker/Desktop/Raport_ST_MAG_20220424T094126.xlsx')
df_inw = pd.read_excel('/home/j0ker/Desktop/inw.xlsx')
...
sap = excel_sap_to_dict(df_sap)

inw = excel_inf_to_list(df_inw)
